...
# question_1；对茄类sm_sort层级进行预测和定价，而不是在code层级上进行预测和定价
sm_qielei_all = account_commodity_mean[account_commodity_mean['sm_sort_name'] == "茄类"]
sm_qielei_all = sm_qielei_all.round(3)
sm_qielei_all.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\teachers_use\data\茄类在全集上的样本.xlsx", index=False, sheet_name='茄类在全集上的样本')
# 获取茄类在训练集上的样本
sm_qielei = sm_qielei_all[:-periods]
# 将训练集上负毛利的异常样本剔除
sm_qielei = sm_qielei[sm_qielei['sum_cost'] <= sm_qielei['sum_price']]
sm_qielei = sm_qielei.round(3)
sm_qielei.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\students_use_data\茄类在训练集上的样本.xlsx", index=False, sheet_name='茄类在训练集上的样本')
...
sm_qielei_amount_effect_compare.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\剔除时间效应前后，历史销量的描述性统计信息对比.xlsx", sheet_name='剔除时间效应前后，历史销量的描述性统计信息对比')
...
sm_qielei_amt_ext_compare.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\数据扩增前后，历史销量的描述性统计信息对比.xlsx", sheet_name='数据扩增前后，历史销量的描述性统计信息对比')
...
all_set.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\茄类全集上的第一次决策结果及时间效应系数.xlsx", index=False, encoding='utf-8-sig', sheet_name='问题1最终结果：茄类全集上的预测订货量及时间效应系数')
...
metrics.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\第一次决策的20种评估指标计算结果.xlsx", index=True, encoding='utf-8-sig', sheet_name='20种评估指标的取值')
print(f'metrics: \n {metrics}', '\n')
...
forecast_output.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\茄类在预测期每日的预测销售额、预测单价、预测成本、预测毛利率、加载毛利率时间效应的第二次报童订货量和加载销量时间效应的最终订货量.xlsx", index=False, encoding='utf-8-sig', sheet_name='问题2最终结果：茄类在预测期每日的预测销售额、预测单价、预测成本、预测毛利率、加载毛利率时间效应的第二次报童订货量和加载销量时间效应的最终订货量')
...
metrics_new.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\加载销量时间效应的最终订货量的20种评估指标计算结果.xlsx", index=True, encoding='utf-8-sig', sheet_name='加载销量时间效应的最终订货量的评估指标值')
print(f'metrics_new: \n {metrics_new}', '\n')
