    ...
    case "forecasting and newsvendor comparison":
        ...
        if code_processed is False:
            ...
            eval_ppfx_all_seg = eval_ppfx_all[
                (eval_ppfx_all["ppfx(%)"] >= 0)
                & (eval_ppfx_all["ppfx(%)"] <= multiplier)
                & (eval_ppfx_all["alpha(%)"] >= 0)
                & (eval_ppfx_all["alpha(%)"] <= 2 * multiplier)
            ...
            eval_ppfx_all.to_csv(
                f"D:\Work info\WestUnion\data\processed\\{organ}\\no_name\\results\\"
                f"eval_ppfx_all__code_processed_{code_processed}_{datetime.date.today()}.csv",
                encoding="utf_8_sig",
            )
            eval_ppfx_all_seg = eval_ppfx_all[
                (eval_ppfx_all["ppfx(%)"] > 0)
                & (eval_ppfx_all["ppfx(%)"] < multiplier)
                & (eval_ppfx_all["alpha(%)"] > 0)
                & (eval_ppfx_all["alpha(%)"] < multiplier)
            ]
