...
account_apple.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\account_apple_processed.xlsx", index=False, sheet_name='流水表经过缺货填补，并按日聚合，再和账表合并sum_cost后的苹果日销售数据')
...
plt.show()
fig1.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_amount.svg", dpi=300, bbox_inches='tight')
fig2.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_amount_components.svg", dpi=300, bbox_inches='tight')
...
apple_prophet_amount.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_prophet_amount_with_effect.xlsx", index=False, sheet_name='用苹果历史销量计算出的时间效应，合并到训练集中')
...
plt.legend(loc='best')
plt.show()
fig.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\剔除时间效应前后，苹果销量时序对比.svg", dpi=300, bbox_inches='tight')
...
apple_train_amount_effect_compare.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_train_amount_effect_compare.xlsx", sheet_name='剔除时间效应前后，苹果历史销量的描述性统计信息对比')
...
apple_train_amt_ext_compare.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_train_amt_ext_compare.xlsx", sheet_name='数据扩增前后，苹果历史销量的描述性统计信息对比')
...
all_set.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_all_set.xlsx", index=False, encoding='utf-8-sig', sheet_name='苹果在全集上的第一次预测订货量及时间效应系数')
...
res = ref.regression_evaluation_single(y_true=apple_all['实际销量'][-periods:], y_pred=apple_all['预测销量'][-periods:])
accu_sin = ref.accuracy_single(y_true=apple_all['实际销量'][-periods:], y_pred=apple_all['预测销量'][-periods:])
...
metrics.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_metrics.xlsx", index=True, encoding='utf-8-sig', sheet_name='第一次计算订货量时，20种评估指标的取值')
print(f'metrics: \n {metrics}', '\n')
...
ax.legend()
plt.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_forecast.svg", dpi=300, bbox_inches='tight')
plt.show()
...
plt.show()
fig1.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_price.svg", dpi=300, bbox_inches='tight')
fig2.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_price_components.svg", dpi=300, bbox_inches='tight')
...
plt.show()
fig1.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_cost.svg", dpi=300, bbox_inches='tight')
fig2.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_fit_cost_components.svg", dpi=300, bbox_inches='tight')
...
forecast.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\results\question_5_final_apple_forecast.xlsx", index=False, encoding='utf-8-sig', sheet_name='问题5最终结果：苹果在预测期每日的预测销售额、预测单价、预测成本、预测毛利率和新订货量')


# 评估指标
res_new = ref.regression_evaluation_single(y_true=apple_all['实际销量'][-periods:], y_pred=forecast['新订货量'][-periods:])
accu_sin_new = ref.accuracy_single(y_true=apple_all['实际销量'][-periods:], y_pred=forecast['新订货量'][-periods:])
...
metrics_new.to_excel(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_metrics_new.xlsx", index=True, encoding='utf-8-sig', sheet_name='新订货量的评估指标值')
print(f'metrics_new: \n {metrics_new}', '\n')
...
ax.legend()
plt.savefig(r"D:\Work info\SCU\MathModeling\2023\data\processed\question5\apple_forecast_new.svg", dpi=300, bbox_inches='tight')
plt.show()
