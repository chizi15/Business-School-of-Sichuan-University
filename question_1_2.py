...
commodity[["class", "bg_sort", "md_sort", "sm_sort", "code"]] = commodity[
    ["class", "bg_sort", "md_sort", "sm_sort", "code"]
].astype("str")
...
account_commodity_mean = account_commodity.groupby(
    [
        "organ",
        "class",
        "bg_sort",
...
os.makedirs(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\teachers_use\data",
    exist_ok=True,
)
sm_qielei_all.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\teachers_use\data\sm_qielei_all.xlsx",
    index=False,
    sheet_name="茄类在全集上的样本",
)
# 获取茄类在训练集上的样本
...
os.makedirs(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\students_use_data",
    exist_ok=True,
)
sm_qielei.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\students_use_data\sm_qielei_train.xlsx",
    index=False,
    sheet_name="茄类在训练集上的样本",
)
...
plt.show()
os.makedirs(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results",
    exist_ok=True,
)
fig1.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_amount.svg",
    dpi=300,
    bbox_inches="tight",
)
fig2.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_amount_components.svg",
    dpi=300,
    bbox_inches="tight",
)
...
qielei_prophet_amount.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\销量时序分解.xlsx",
    index=False,
    sheet_name="用历史销量计算出的时间效应，合并到训练集中",
)
...
sm_qielei["amt_no_effect"] = (
    sm_qielei["amount"].values / (1 + qielei_prophet_amount["total_effect"]).values
)
...
plt.show()
fig.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\剔除时间效应前后，茄类销量时序对比.svg",
    dpi=300,
    bbox_inches="tight",
)
...
sm_qielei_amount_effect_compare.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\sm_qielei_amount_effect_compare.xlsx",
    sheet_name="剔除时间效应前后，历史销量的描述性统计信息对比",
)
...
plt.show()
fig.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\\results\\数据扩增前后，历史销量的概率密度函数对比图.svg",
    dpi=300,
    bbox_inches="tight",
)
...
sm_qielei_amt_ext_describe = pd.Series(
    sm_qielei_amt_ext, name="sm_qielei_amt_ext_describe"
).describe()
...
).rename(columns={"amt_no_effect": "sm_qielei_amt_describe"})
...
sm_qielei_amt_ext_compare.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\sm_qielei_amt_ext_compare.xlsx",
    sheet_name="数据扩增前后，历史销量的描述性统计信息对比",
)
...
profit_avg = (
    sm_qielei["profit_daily"].mean() + np.percentile(sm_qielei["profit_daily"], 50)
) / 2
...
comparison_of_distributions_qielei.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\comparison_of_distributions_qielei.xlsx",
    sheet_name="comparison of distributions_qielei",
)
...
plt.show()
figure.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\comparison of distributions_qielei.svg"
)
...
plt.show()
figure.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\best distribution_qielei.svg"
)
figure.clear()
...
yearly_effect_avg = (
    all_set[:-periods].groupby(["month", "day"])["yearly_effect"].mean().reset_index()
)
all_set = pd.merge(
    all_set, yearly_effect_avg, on=["month", "day"], how="left", suffixes=("", "_avg")
...
all_set.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\question_1_final_qielei_all_set.xlsx",
    index=False,
    encoding="utf-8-sig",
    sheet_name="问题1最终结果：茄类全集上的预测订货量及时间效应系数",
)


# 使用ref评估最后一周，即预测期的指标
sm_qielei_all = account_commodity_mean[
    account_commodity_mean["sm_sort_name"] == "茄类"
][["busdate", "amount"]].rename(columns={"busdate": "销售日期", "amount": "实际销量"})
...
metrics.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\qielei_metrics.xlsx",
    index=True,
    encoding="utf-8-sig",
    sheet_name="20种评估指标的取值",
)
print(f"metrics: \n {metrics}", "\n")
...
ax.plot(
    ...
    sm_qielei_seg["实际销量"][-output_index:],
    label="实际销量",
    marker="o",
)
ax.plot(
...
ax.legend()
plt.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\qielei_forecast.svg",
    dpi=300,
    bbox_inches="tight",
)
plt.show()
...
plt.show()
fig1.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_revenue.svg",
    dpi=300,
    bbox_inches="tight",
)
fig2.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_revenue_components.svg",
    dpi=300,
    bbox_inches="tight",
)
forecast_price.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\销售额时序分解.xlsx",
    index=False,
    encoding="utf-8-sig",
    sheet_name="预测销售额",
)
...
plt.show()
fig1.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_unit_cost.svg",
    dpi=300,
    bbox_inches="tight",
)
fig2.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\fit_unit_cost_components.svg",
    dpi=300,
    bbox_inches="tight",
)
forecast_cost.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\单位成本时序分解.xlsx",
    index=False,
    encoding="utf-8-sig",
    sheet_name="预测单位成本",
)
...
for i in range(len(forecast["profit"])):
    q_steady_star.append(
        stats.gamma.ppf(forecast["profit"].values[i], *f_star.fitted_param["gamma"])
    )
...
forecast[["加载毛利率时间效应的第二次报童订货量", "加载销量时间效应的最终订货量"]] = (
    forecast[
...
forecast_output.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\question_2_final_qielei_forecast.xlsx",
    index=False,
    encoding="utf-8-sig",
    sheet_name="问题2最终结果：茄类在预测期每日的预测销售额、预测单价、预测成本、预测毛利率、加载毛利率时间效应的第二次报童订货量和加载销量时间效应的最终订货量",
)

# 评估指标
res_new = ref.regression_evaluation_single(
    y_true=sm_qielei_all["实际销量"][-periods:].values,
    y_pred=forecast["加载销量时间效应的最终订货量"][-periods:].values,
)
...
metrics_new.to_excel(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\qielei_metrics_final.xlsx",
    index=True,
    encoding="utf-8-sig",
    sheet_name="加载销量时间效应的最终订货量的评估指标值",
)
print(f"metrics_new: \n {metrics_new}", "\n")
...
ax.plot(
    ...
    sm_qielei_all["实际销量"][-output_index:],
    marker="o",
    label="实际销量",
)
ax.plot(
    forecast["销售日期"][-output_index:],
    forecast["加载销量时间效应的最终订货量"][-output_index:],
    marker="o",
...
ax.legend()
plt.savefig(
    r"D:\Work info\SCU\MathModeling\2023\data\processed\question_1_2\results\qielei_forecast_final.svg",
    dpi=300,
    bbox_inches="tight",
)
plt.show()
