...
code_busdate = acct_code_sm_loss_cost.groupby('code').agg(min_busdate=('busdate', 'min'), max_busdate=('busdate', 'max')).reset_index()
code_busdate_codes = code_busdate[(code_busdate['min_busdate'] == first_day) & (code_busdate['max_busdate'] == last_day)]['code']
sale_sm = acct_code_sm_loss_cost[acct_code_sm_loss_cost['code'].isin(code_busdate_codes)]
